                                        ...
                                        {requests.data.length === 0 ? (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    {item.transfer_fee_amount > 0 ? (
                                                        <div className="text-xs space-y-1">
                                                            ...
                                                            <Badge className={(item.transfer_fee_paid || !!item.transfer_fee_or_number || item.transfer_balance_due <= 0) ? 'bg-green-100 text-green-700 border-green-200' : 'bg-amber-100 text-amber-700 border-amber-200'}>
                                                ...
                                                <TableCell className="text-right" onClick={(e) => e.stopPropagation()}>
                                                    ...
                                                    ) : item.accounting_status === 'approved' && item.student.is_active && (item.transfer_fee_amount <= 0 || item.transfer_fee_paid || !!item.transfer_fee_or_number || item.transfer_balance_due <= 0) ? (
