...
import { TrendingUp, Users, Wallet, CalendarDays, CheckCircle, AlertTriangle, XCircle, BarChart3 } from 'lucide-react';
...
export default function SuperAccountingDashboard({
    ...
    const handleFilterChange = (month: number, year: number) => {
        router.get('/super-accounting/dashboard', {
            month, year,
    ...
    const handleReset = () => {
        ...
        setYearLevel('');
        setSection('');
        router.get('/super-accounting/dashboard', { month: selectedMonth, year: selectedYear });
    };
